...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2025 at 06:26 PM
...
INSERT INTO `items` (`id`, `name`, `price`, `item_image`, `deleted`) VALUES
(1, 'Composite manure', 3500, '', 0),
(2, 'Urea', 2130, '', 0);
...
(1, 4, 'Bigwa', 'Mteja wetu namba 1', '2022-09-26 10:15:51', 'Wallet', 1126, 'Cancelled by Customer', 1),
(2, 4, 'Kichangani', 'Mteja wa mbolea', '2022-09-26 10:24:50', 'Wallet', 776, 'Delivered', 0);
...
(1, 4, 'My ticket', 'This is my sample ticket description for demo purposes only.', 'Closed', 'Support', '2022-09-26 10:25:31', 0);
...
(1, 'Administrator', 'Sara Yohana', 'sara', '$2y$10$vSCV6JHGpGn7Iwyb/DCZYuMA.6h.3qeL6ku35vjvfgK21cLNiETbO', 'sara@gmail.com', 'Kola B, Kichangani', 255758559244, 1, 0),
(4, 'Customer', 'Jacklina', 'jackline', '$2y$10$yPP1O4sO2yjrdxdyS5XfuOH04rnNpDMsrVs.eNtlJ5iF2CiOdfjjm', 'jackline@gmail.com', 'Sample Address', 255718981290, 1, 0),
(5, 'Customer', 'John', 'john', '$2y$10$1lgR2XKGBrlVaF5I.ReUgeJsGsKA/1TgS0dfpSn9ttLpM7jKa4D76', NULL, NULL, 255753940450, 0, 0);
