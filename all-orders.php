    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-light-blue"><i class="mdi-maps-local-restaurant"></i> Product Menu</a>
            </li>
                <li class="no-padding">
                            ...
                            <span>Tsh'.$row1['price'].'</span>
								...
								echo'<li class="collection-item">
                                        <div class="row">
                                            ...
                                            <div class="col s3">
                                                <span><strong>Tsh'.$row['total'].'</strong></span>
                                            </div>';										
								if(!$deleted){
