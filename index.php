...
<body>
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1">Agrovert Products Ordering System</a></h1></li>
                    </ul>
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#" class="waves-effect waves-block waves-light">  <b>Tsh</b> <?php echo $balance;?></i></a>
                        </li>
                    </ul>					
                </div>
            </nav>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-light-blue"><i class="mdi-maps-local-restaurant"></i> Order Product</a>
            </li>
                <li class="no-padding">
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="place-order.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Order Product</h4>
              </div>
              <div>
				...
				{
					echo '<tr><td>'.$row["name"].'</td><td>'.'Tsh '.$row["price"].'</td>';                      
 ...
 <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © <?php echo date("Y"); ?><span class="right"><a class="grey-text text-lighten-4" href="">Sara L. Yohana</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
